...
self.addEventListener('fetch', e => {
  ...
  if (/(^|\.)(open-meteo\.com|overpass-api\.de|nominatim\.openstreetmap\.org|api\.postcodes\.io|datamap\.gov\.wales)$/.test(new URL(e.request.url).hostname)) return;
