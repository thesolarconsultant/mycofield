...
self.addEventListener('fetch', e => {
  ...
  if (/(^|\.)(open-meteo\.com|overpass-api\.de|nominatim\.openstreetmap\.org|api\.postcodes\.io|datamap\.gov\.wales|arcgis\.com)$/.test(new URL(e.request.url).hostname)) return;
