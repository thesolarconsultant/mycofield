# MycoField Conditions Index — methodology (conditions-v0.3)
...
| Habitat | OpenStreetMap land-use/natural tags via Overpass `is_in`, or set by the user in the field | OSM mapping is uneven; unmapped = unknown | 10% | Semi-natural grassland 100, amenity grass 70, heath/moor 60, farmland 55, scrub 35, wetland 35, woodland 25, bare 10, built-up 10, water 0 |
